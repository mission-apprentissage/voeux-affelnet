...
//
// "RESPONSABLE_ACCOUNT_ACTIVATED";"Responsable, Formateur";"[email resp] a créé son mot de passe de connexion au service."
// "RESPONSABLE_ACCOUNT_ACTIVATION_EMAIL_MANUAL_RESENT";"Responsable, Formateur";"[Email super admin] a généré l'envoi d'un rappel à [mail admin responsable] pour création de son mot de passe."
// "RESPONSABLE_ACCOUNT_ACTIVATION_EMAIL_AUTOMATIC_RESENT";"Responsable, Formateur";"Action automatique – [email resp] a reçu un rappel de demande de création de mot de passe."
// "RESPONSABLE_ACCOUNT_CONFIRMED";"Responsable, Formateur";"[email] a confirmé son adresse courriel. La personne est invitée à cliquer sur un lien pour créer son mot de passe de connexion."
// "RESPONSABLE_ACCOUNT_CONFIRMATION_EMAIL_MANUAL_RESENT";"Responsable, Formateur";"[Email super admin] a généré l'envoi d'un rappel à [mail admin responsable] pour confirmation de son adresse courriel."
// "RESPONSABLE_ACCOUNT_CONFIRMATION_EMAIL_AUTOMATIC_RESENT";"Responsable, Formateur";"Action automatique – Un rappel de demande de confirmation d'adresse courriel a été envoyée à [email]"
// "RESPONSABLE_ACCOUNT_CONFIRMATION_EMAIL_AUTOMATIC_SENT";"Responsable, Formateur";"Action automatique – Une demande de confirmation d'adresse courriel a été envoyée à l'organisme [responsable/vide] [email]"
//
// "RESPONSABLE_ACCOUNT_EMAIL_UPDATED_BY_ADMIN";"Responsable, Formateur";"[Email super admin] a modifié l'email du directeur de l'organisme. Nouvelle adresse [email] (adresse précédente : [email])"
// "RESPONSABLE_ACCOUNT_EMAIL_UPDATED_BY_ACCOUNT";"Responsable, Formateur";"Modification d'email // lors de la création de compte // via page profil"
//
// "RESPONSABLE_ACCOUNT_EMAIL_CREATED";"Responsable, Formateur";"Enregistrement de l'email en base de données ([email]). Origine de l'email : [diffusion des listes 2022 | Adresse associée au Siret [Siret] sur les offres 2023 enregistrées auprès du Carif-Oref] | Edition manuelle par [mail admin]"
