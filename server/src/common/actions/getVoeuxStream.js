...
function getVoeuxStream({ uai_responsable, uai_formateur }) {
  return compose(
    Voeu.find({ "etablissement_responsable.uai": uai_responsable, "etablissement_formateur.uai": uai_formateur })
      .lean()
      .cursor(),
    transformData((voeu) => {
      return {
