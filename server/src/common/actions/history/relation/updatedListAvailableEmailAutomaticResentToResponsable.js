...
const saveUpdatedListAvailableEmailAutomaticResentToResponsable = async ({ relation, responsable }) => {
  await Relation.updateOne(
    { _id: relation._id },
    {
      $push: {
        histories: {
          action: RelationActions.UPDATED_LIST_AVAILABLE_EMAIL_AUTOMATIC_RESENT_TO_RESPONSABLE,
          variables: {
