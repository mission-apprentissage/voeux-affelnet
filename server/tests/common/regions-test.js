...
describe("regions", () => {
  it.skip("Permet de trouver une région avec son UAI", () => {
  ...
  it.skip("Permet de trouver une région à partir d'un code INSEE", () => {
  ...
  it.skip("Permet de trouver une région à partir du code de l'académie", () => {
  ...
  it.skip("Permet de trouver une région avec son nom", () => {
    assert.deepStrictEqual(findRegionByName("Île-de-France").code, "11");
  });

  it.skip("Permet de trouver une région avec son code", () => {
