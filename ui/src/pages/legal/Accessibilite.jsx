...
export const Accessibilite = () => {
  ...
  return (
    <Box w="100%" pt={[4, 8]} px={[1, 1, 12, 24]}>
      <Container maxW="none">
        <Heading as="h2" textStyle="h2" mt={5}>
          {title}
        </Heading>
        <Box pt={4} pb={16}>
          <Box>
            <Text>
              ...
              peuvent contribuer sur le Web. L'accessibilité du Web bénéficie aussi à d'autres, notamment les personnes
              âgées dont les capacités changent avec l'âge. L'accessibilité du Web comprend tous les handicaps qui
              affectent l'accès au Web, ce qui inclut les handicaps visuels, auditifs, physiques, de paroles, cognitives
              et neurologiques.
              <br />
              <br />
