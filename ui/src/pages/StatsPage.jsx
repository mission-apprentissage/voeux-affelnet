...
function StatsPage() {
  ...
  return (
    <>
      <Breadcrumb items={[{ label: title, url: "/stats" }]} />
            ...
            <Box>
              ...
              <StatGroup mb={4}>
                <Stat mr={2}>
                  ...
                  <StatHelpText>
                    (soit{" "}
                    {+((organismes?.totalResponsableAvecDelegation * 100) / organismes?.totalResponsable).toFixed(2)}%
                    des responsables)
                  </StatHelpText>
                </Stat>
            ...
            <Box>
              ...
              <StatGroup mb={4}>
                ...
                <Stat mr={2}>
                  ...
                  <StatLabel>
                    Nombre d’organismes responsables n’ayant téléchargé qu’une partie des candidatures (tous formateurs
                    et toutes mises à jour)
                  </StatLabel>
                  <StatNumber>
                          ...
                          {organismes?.totalResponsable > 0 && (
                            <>
                              ...
                              <b>
                                {
                                  +(
                                    (organismes?.totalResponsableActivated * 100) /
                                    organismes?.totalResponsable
                                  ).toFixed(2)
                                }
                                %
