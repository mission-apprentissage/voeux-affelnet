...
const GestionnaireStatut = ({ gestionnaire }) => {
  ...
  async function search(values) {
    try {
      ...
      const params = queryString.stringify(
        { ...values, sort: JSON.stringify({ username: 1 }) },
                    ...
                    {
                      {
                        Gestionnaire: (
                          <>
                            ...
                            <Td>
                              <GestionnaireEmail gestionnaire={user} />
                            </Td>
                            <Td>{getStatutVoeux(user)}</Td>
                            <Td>
                        ...
                        Formateur: (
                          <>
                            ...
                            <Td>{/* <FormateurEmail formateur={user} /> */}</Td>
                            <Td>{/* {getStatutVoeux(formateur)} */}</Td>
                            <Td>{/* <GestionnaireStatut formateur={formateur} /> */}</Td>
                          </>
                        ),
                      }[user.type]
                    }
