        ...
        <AccordionItem mb={0}>
          ...
          <AccordionPanel pb={4}>
            ...
            <UnorderedList>
              ...
              <ListItem>
                <Text mb={4}>
                  Phase 3 : entre le 18 juin et le 21 juin 2024, diffusion par courriel des notifications de mise à jour
                  des listes de candidats (le cas échéant). Les mises à jour peuvent correspondre à des suppressions,
