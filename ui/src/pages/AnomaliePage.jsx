...
export const AnomaliePage = () => {
  ...
  return (
    <>
      <Breadcrumb items={[{ label: title, url: "/support" }]} />
      ...
      <Page title={title}>
        ...
        <Accordion defaultIndex={[]} allowToggle>
          ...
          <AccordionItem mb={0}>
            ...
            <AccordionPanel pb={4}>
              <Text mb={4}>
                Les relations entre les organismes responsables des offres de formation et les organismes formateurs
                sont basées sur les enregistrements effectués auprès des Carif-Oref.
              </Text>
              <Text mb={4}>
          ...
          <AccordionItem mb={0}>
            ...
            <AccordionPanel pb={4}>
              <Text mb={4}>
                ...
                ) à partir du numéro de Siret enregistré par le Carif-Oref. Les couples Siret-UAI sont fiabilisés par
                les services statistiques des académies.{" "}
              </Text>
              <Text mb={4}>
          ...
          <AccordionItem mb={0}>
            ...
            <AccordionPanel pb={4}>
              ...
              <Text mb={4}>
                En fonction de la provenance des informations, vous pourrez vous rapprocher soit de l'Insee, soit de
                votre{" "}
                <Link variant="action" href="https://www.intercariforef.org/referencer-son-offre-de-formation">
                  Carif-Oref
                </Link>
              ...
              <Text mb={4}>
                ...
                , il est possible que votre offre ait été créée directement dans Affelnet par le SAIO dont vous
                dépendez. Rapprochez-vous dans ce cas de votre SAIO.
              </Text>
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem mb={0}>
            ...
            <AccordionPanel pb={4}>
              ...
              <Text mb={4}>
                Si le problème se reproduit, essayez si possible de vous connecter à partir d'un autre navigateur
                internet (Firefox, Chrome, Safari, Edge, …).
              </Text>
              <Text mb={4}>
          ...
          <AccordionItem mb={0}>
            ...
            <AccordionPanel pb={4}>
              ...
              <UnorderedList>
                <ListItem>
                  <Text mb={4}>
                    Phase 1 : une première campagne courriel est diffusée en première quinzaine de mai, afin
                    d'identifier les directeurs d’organismes responsables, confirmer leur adresse email, et leur
                    permettre de créer leur mot de passe de connexion au service.
                  </Text>
                  <Box mb={4}>
                    <Text as="i">
                ...
                <ListItem>
                  <Text mb={4}>
                    Phase 1bis (optionnelle) : les directeurs d'organismes responsables activent, s’ils le souhaitent,
                    des délégations de droits permettant à d'autres personnes d'accéder au service de téléchargement des
                    listes pour les organismes formateurs. Chaque organisme formateur peut faire l'objet d'une
                    délégation de droits distincte.
                  </Text>
                </ListItem>
